...
Version  : 0.5.5
Release  : 37
URL      : https://cran.r-project.org/src/contrib/RandomFieldsUtils_0.5.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFieldsUtils_0.5.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633446682
