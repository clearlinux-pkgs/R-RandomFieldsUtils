...
Source0  : https://cran.r-project.org/src/contrib/RandomFieldsUtils_0.3.25.tar.gz
Summary  : Utilities for the Simulation and Analysis of Random Fields
Group    : Development/Tools
License  : GPL-3.0
Requires: R-RandomFieldsUtils-lib
Requires: R-spam
...
export LANG=C
export SOURCE_DATE_EPOCH=1521215623
...
/usr/lib64/R/library/RandomFieldsUtils/include/init_RandomFieldsUtils.h
