...
Version  : 1.2.3
Release  : 47
URL      : https://cran.r-project.org/src/contrib/RandomFieldsUtils_1.2.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFieldsUtils_1.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648741027
